...
export function evaluateSessionFreshness(params: {
	...
	const dailyResetAt = policy.mode === "daily" ? resolveDailyResetAtMs(params.now, policy.atHour) : undefined;
	const idleExpiresAt = policy.idleMinutes != null ? params.updatedAt + policy.idleMinutes * 60_000 : undefined;
